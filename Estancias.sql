...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-03-2022 a las 14:50:04
...
(121595, 'faraon', 'love', 'shady', 'gtghi', 'hombre', '528258', 'hbnk098', 'yhhyh@tuy.kii', 1, 1, 1),
(1915031184, 'yo', 'vazquez', 'olvera', 'mi casa', 'hombre', '1793636', 'vaojo76ds3', 'nhurf@tukh.nfg', 1, 1, 1),
(1915031201, 'eno', 'balleno', 'berraco', 'actopan', 'hombre', '123456', 'fige897654', 'enoc@gmail.com', 1, 1, 1);
...
--
-- Volcado de datos para la tabla `telefono_alumno`
--

INSERT INTO `telefono_alumno` (`id_telefono_alumno`, `Telefono_casa_al`, `Telefono_celular_al`, `Matricula_fk`) VALUES
(1, 7727272677, 7721221339, 1915031201),
(2, 7728946135, 7789654132, 1915031184);
