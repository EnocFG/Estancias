...
//hace la consulta
$consulta = "SELECT * FROM usuario WHERE usuario = '" . $usuario . "' and contrasenia = '" . $pass . "'";
...
if (($nr['id_cargo'] == 1)) { //envia al apartado administrador - admin (admin-admin1234)
    header("Location: menuadmin/menuad.php");
    //echo "Bienvenido: ".$nombre;
    //echo ['success_msg'];
} else if (($nr['id_cargo'] == 2)) { //envia al apartado - alumno (alumno1-alumno1234)
