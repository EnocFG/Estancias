    ...
    <div class="window-notice" id="window-notice">
      <div class="content">
        <div class="content-text">
          ...
          <input type="submit" name="Docentes" onclick="location.href='../menuadmin/Asesores/menu_asesores.php'" value="Docentes">
          <input type="submit" name="Empresas" onclick="location.href='../menuadmin/Empresas/menu_empresas.php'" value="Empresas">
        </div>
